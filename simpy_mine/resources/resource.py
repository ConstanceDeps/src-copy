...
"""
from simpy_mine.core import BoundClass
from simpy_mine.resources import base


class Preempted(object):
    """Cause of an preemption :class:`~simpy_mine.events.Interrupt` containing
    information about the preemption.

    """
    def __init__(self, by, usage_since):
        self.by = by
        """The preempting :class:`simpy_mine.events.Process`."""
...
class Request(base.Put):
    ...
    granted. Subclass of :class:`simpy_mine.resources.base.Put`.
...
class Release(base.Get):
    ...
    triggered immediately. Subclass of :class:`simpy_mine.resources.base.Get`.
...
class Resource(base.BaseResource):
    ...
    The *env* parameter is the :class:`~simpy_mine.core.Environment` instance the
    ...
    def __init__(self, env, capacity=1):
        ...
        :attr:`~simpy_mine.resources.base.BaseResource.put_queue`.
        """
...
class PriorityResource(Resource):
    """A :class:`~simpy_mine.resources.resource.Resource` supporting prioritized
    requests.
    ...
    :attr:`~simpy_mine.resources.base.BaseResource.put_queue` for details."""
    GetQueue = list
    """Type of the get queue. See
    :attr:`~simpy_mine.resources.base.BaseResource.get_queue` for details."""
...
class PreemptiveResource(PriorityResource):
    """A :class:`~simpy_mine.resources.resource.PriorityResource` with preemption.

    If a request is preempted, the process of that request will receive an
    :class:`~simpy_mine.events.Interrupt` with a :class:`Preempted` instance as
    cause.
