"""
Base classes of for simpy_mine's shared resource types.
...
from simpy_mine.events import Event
...
class Put(Event):
    ...
    request if an exception (like an :class:`simpy_mine.events.Interrupt` for
    example) occurs:
    ...
    def cancel(self):
        ...
        :class:`~simpy_mine_min.events.Interrupt`.
...
class Get(Event):
    ...
    def cancel(self):
        ...
        example if a process needs to handle an exception like an
        :class:`~simpy_mine.events.Interrupt`.
